...
class chat_window(object):
    ...
    def __init__(self, Form, s, username, group):
        ...
        self.attach_file.file = '/home/sami/Pictures/download.png'
...
##        self.Voice_record.clicked.connect(self.record_audio)
    ...
    def send(self, Type):
        ...
        if Type == 'msg':
            ...
            if os.path.isfile(self.attach_file.file):
                ...
                msg = 'Attach ' + self.u[:-1] + ' ' + self.group + ' ' + self.attach_file.file + ' ' + Format
    ...
    def update_listwidget(self, i):
        ...
        if i[0] == self.u[:-1]:
            me = True
        if i[1] == 'Attach':
            path = '/home/sami/Documents/Computer/server_and_client/' + 'client/files/' + self.group + '/' + i[2]
